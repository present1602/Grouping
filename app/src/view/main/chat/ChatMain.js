  ...
  render() {
    let view = (
      <View style={styles.container}>
        ...
        />
        <AdArea />
        <View style={styles.listContainer} padding={5} flexDirection="column" flex={1}>
          <FlatList
    ...
    if (this.props.chatStore.chatViewStatus === CHAT_VIEW_STATUS.ENTERING_CHAT_ROOM) {
      view = (
        <View>
          <ChatRoomHeader backButtonClicked={this.onChatContentsBackButtonClicked.bind(this)} />
          <ChatRoomMain />
        </View>
      );
    }
...
function Item({ onChatContentEnterButtonClicked }) {
  return (
    <TouchableOpacity onPress={() => onChatContentEnterButtonClicked()}>
      <View style={styles.itemContainer}>
        ...
        <View flexDirection="column" flex={1} padding={5}>
          <View flexDirection="row">
            ...
            <Text style={styles.lastMessageTime}>12:00</Text>
          </View>
